        ...
        <nav class="navbar navbar-expand-lg custom_nav-container ">
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav  ml-auto">
              ...
              <li class="nav-item">
                <a class="nav-link" href="serviceManActions.html">About</a>
              </li>
...
<%
	try
	{
		...
		PreparedStatement ps=con.prepareStatement("select * from complaints where sid=? and status=?");
		ps.setInt(1,sid);
		...
		{%>
			...
			<td class=" d-flex justify-content-center align-items-center btn btn-danger btn-sm p-0 mt-2"><a href=MarkAsSolved.jsp?comp_id=<%=rs.getInt(1)%>&service_code=<%=rs.getString(11)%> style="color:white"><%=rs.getString(9)%></a></td>
			<td><%=rs.getInt(10)%></td>
			</tr>
		<%}
	}
