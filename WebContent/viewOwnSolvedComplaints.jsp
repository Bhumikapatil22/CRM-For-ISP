...
<div class=" mx-5">
<table class="table table-striped w-80 mx-auto" >
...
<%
	try
	{
		...
		{%>
			...
			<td class=" d-flex justify-content-center align-items-center btn btn-success btn-sm text-white p-0 mt-2"><%=rs.getString(9)%></td>
			<td><%=rs.getInt(10)%></td>
			</tr>
		<%}
	}
