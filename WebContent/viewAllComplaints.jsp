...
try
{
	...
	{%>
		...
		<td style="color:red"><%=rs.getString(9)%></td>
		<td class="btn btn-pending  p-1 mt-2 btn-sm" style="background-color:#ffc107"><a href="AssignComplaints.jsp?comp_id=<%=rs.getInt(1)%>" style="color:black">Assign to</a></td>
